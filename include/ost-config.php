...
define('SECRET_SALT','1oJH21bxSSW7gFS8CDHowSNpcGY0F65J');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','syork@uahmgt.com');
...
define('DBTYPE','mysql');
define('DBHOST','mayfair-mysql-01.mysql.database.azure.com');
define('DBNAME','support');
define('DBUSER','maysup@mayfair-mysql-01');
define('DBPASS','&A3ezaSw');
